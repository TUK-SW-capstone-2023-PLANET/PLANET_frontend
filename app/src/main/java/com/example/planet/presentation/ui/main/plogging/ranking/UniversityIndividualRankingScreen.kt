    ...
    Column(
        ...
        Row(
            ...
            UniversityIndividualGraph(
                visible = visible,
                score = mainViewModel.myUniversityTop4RankingUsers[1].score.numberComma(),
                graphHeight = mainViewModel.universityUserGraphHeightList[0],
                colors = listOf(Color(0XFFD1CFCF), Color(0XFFFFFFFF)),
                userName = mainViewModel.myUniversityTop4RankingUsers[1].nickName,
            )
            UniversityIndividualGraph(
                visible = visible,
                score = mainViewModel.myUniversityTop4RankingUsers[0].score.numberComma(),
                graphHeight = mainViewModel.universityUserGraphHeightList[1],
                colors = listOf(Color(0xFFFFCC31), Color(0XFFFFFFFF)),
                userName = mainViewModel.myUniversityTop4RankingUsers[0].nickName,
            )
            UniversityIndividualGraph(
                visible = visible,
                score = mainViewModel.myUniversityTop4RankingUsers[2].score.numberComma(),
                graphHeight = mainViewModel.universityUserGraphHeightList[2],
                colors = listOf(Color(0xFFE1B983), Color(0XFFFFFFFF)),
                userName = mainViewModel.myUniversityTop4RankingUsers[2].nickName,
            )
        }
