...
import com.example.planet.presentation.ui.user.component.UserHeightWeightTextField
...
fun ProfileModifyScreen(userViewModel: UserViewModel, onClick: () -> Unit) {
    ...
    Column(
        ...
        MyProfileImage(
            setProfileImage = { userViewModel.myProfileImage = it },
            profileImage = { userViewModel.myProfileImage })
